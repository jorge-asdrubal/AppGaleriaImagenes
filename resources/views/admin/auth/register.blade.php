                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('users.save') }}">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('name') id-invalid @enderror" id="name" name="name" type="name" placeholder="Enter your name..." />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('email') id-invalid @enderror" id="email" name="email" type="email" placeholder="name@example.com" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('password') id-invalid @enderror" id="password" name="password" type="password" placeholder="Contraseña" />
